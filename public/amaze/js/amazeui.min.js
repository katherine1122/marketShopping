...
!function (t, e) {
    ...
    return function (t) {
        ...
        s.VERSION = "2.7.0", s.support = {}, s.support.transition = function () {
            var t = function () {
            ...
            if (!s)return !1;
            var a = o.scrollLeft(), r = o.scrollTop(), l = i.offset(), c = l.left, h = l.top;
            return e = n.extend({
                topOffset: 0,
                leftOffset: 0
            ...
            i = i || {}, n.fn[t] = function (o) {
                var a, r = Array.prototype.slice.call(arguments, 0), l = r.slice(1), c = this.each(function () {
                    var c = n(this), h = "amui." + t, u = i.dataOptions || "data-am-" + t, d = c.data(h), p = n.extend({}, s.utils.parseOptions(c.attr(u)), "object" == typeof o && o);
        ...
        function D(t, e) {
            ...
            if (e.eventType != It && (r > $t || void 0 === a.velocity)) {
                var l = e.deltaX - a.deltaX, c = e.deltaY - a.deltaY, h = $(r, l, c);
        ...
        var ht, ut = i(1), dt = i(2), pt = ["", "webkit", "Moz", "MS", "ms", "o"], mt = document.createElement("div"), ft = "function", vt = Math.round, gt = Math.abs, yt = Date.now;
        ...
        var oe = w(mt.style, "touchAction"), ae = void 0 !== oe, re = "compute", le = "auto", ce = "manipulation", he = "none", ue = "pan-x", de = "pan-y", pe = j();
        X.prototype = {
            set: function (t) {
                ...
                var n = this.actions, s = m(n, he) && !pe[he], o = m(n, de) && !pe[de], a = m(n, ue) && !pe[ue];
                if (s) {
        ...
        Z.prototype = {
            ...
            defaults: {
                ...
                if (s && o && i) {
                    ...
                    var a = this.pTime ? t.timeStamp - this.pTime < e.interval : !0, r = !this.pCenter || P(this.pCenter, t.center) < e.posThreshold;
        ...
        a.DEFAULTS = {toggle: !0}, a.prototype.open = function () {
            ...
            var e, i = s(this), a = o.utils.options(i.attr("data-am-collapse")), r = a.target || t.preventDefault() || (e = i.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""), l = s(r), c = l.data("amui.collapse"), h = c ? "toggle" : a, u = a.parent, d = u && s(u);
        ...
        (function (e) {
            ...
            n.flexslider = function (t, i) {
                ...
                var a, r = s.vars.namespace, l = window.navigator && window.navigator.msPointerEnabled && window.MSGesture, c = ("ontouchstart" in window || l || window.DocumentTouch && document instanceof DocumentTouch) && s.vars.touch, h = "click touchend MSPointerUp keyup", u = "", d = "vertical" === s.vars.direction, p = s.vars.reverse, m = s.vars.itemWidth > 0, f = "fade" === s.vars.animation, v = "" !== s.vars.asNavFor, g = {};
                n.data(t, "flexslider", s), g = {
                    init: function () {
                        ...
                        function o(t) {
                            ...
                            if (e) {
                                if (e.animatingTo === e.currentSlide && !b && null !== u) {
                                    var i = p ? -u : u, n = i > 0 ? e.getTarget("next") : e.getTarget("prev");
                        ...
                        var a, r, c, h, u, v, g, y, w, b = !1, T = 0, x = 0, C = 0;
                        l ? (t.style.msTouchAction = "none", t._gesture = new MSGesture, t._gesture.target = t, t.addEventListener("MSPointerDown", i, !1), t._slider = s, t.addEventListener("MSGestureChange", n, !1), t.addEventListener("MSGestureEnd", o, !1)) : (g = function (e) {
                            ...
                            if (t.removeEventListener("touchmove", y, !1), s.animatingTo === s.currentSlide && !b && null !== u) {
                                var i = p ? -u : u, n = i > 0 ? s.getTarget("next") : s.getTarget("prev");
        ...
        n.prototype = {
            version: "5.2.0", _init: function () {
                ...
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n = (t.changedTouches ? t.changedTouches[0] : t, a.getTime() - this.startTime), s = Math.round(this.x), o = Math.round(this.y), r = Math.abs(s - this.startX), l = Math.abs(o - this.startY), c = 0, h = "";
                ...
                var r = this, l = this.x, c = this.y, h = a.getTime(), u = h + i;
        ...
        c.DEFAULTS = {duration: 300, effect: "overlay"}, c.prototype.open = function (t) {
            ...
            if (i.length && !i.hasClass("am-active")) {
                var n = this.options.effect, o = s("html"), l = s("body"), c = i.find(".am-offcanvas-bar").first(), h = c.hasClass("am-offcanvas-bar-flip") ? -1 : 1;
                c.addClass("am-offcanvas-bar-" + n), a = {
                    ...
                    height: r.height()
                }).addClass("am-offcanvas-page"), "overlay" !== n && l.css({"margin-left": c.outerWidth() * h}).width(), o.css("margin-top", -1 * a.y), setTimeout(function () {
        ...
        var n = i(1), s = i(2), o = s.utils.rAF, a = function (t) {
            ...
            var s = function (t, e) {
                ...
                t.addEventListener("touchstart", function (t) {
                    ...
                    if (e.enabled) {
                        if (p)r(t), i && u(t), o = l(t.touches); else {
                            switch (i) {
                                case"zoom":
        ...
        a.DEFAULTS = {
            ...
            if (e && e.length) {
                var i = e.outerWidth(), n = e.outerHeight(), s = e.find(".am-popover-caret"), a = s.outerWidth() / 2 || 8, r = n + 8, l = t.outerWidth(), c = t.outerHeight(), h = t.offset(), u = t[0].getBoundingClientRect(), d = o.height(), p = o.width(), m = 0, f = 0, v = 0, g = 2, y = "top";
                e.css({
                    left: "",
                    top: ""
            ...
            l.configure = function (t) {
                ...
                return s.offsetWidth, h(function (t) {
                    "" === c.positionUsing && (c.positionUsing = l.getPositioningCSS()), u(o, i(e, a, r)), 1 === e ? (u(s, {
                        ...
                        u(s, {transition: "all " + a + "ms linear", opacity: 0}), setTimeout(function () {
                            l.remove(), t()
                        }, a)
                    }, a)) : setTimeout(t, a)
                }), this
                ...
                var n, o = i.querySelector(c.barSelector), a = t ? "-100" : e(l.status || 0), h = document.querySelector(c.parent);
                return u(o, {
        ...
        c.DEFAULTS = {
            ...
            this.refreshSlides(), n("body").append(s), this.$title = s.find(e.selector.title), this.$current = s.find(e.selector.current), this.$bar = s.find(e.selector.bar), this.$actions = s.find(e.selector.actions), e.shareBtn && this.$actions.append('<a href="javascript: void(0)" class="am-icon-share-square-o" data-am-toggle="share"></a>'),
        ...
        var n = i(1), s = i(2), o = s.utils.rAF, a = s.utils.cancelAF, r = !1, l = function (t, e) {
            ...
            e = e || {};
            var h, u, d, p = n(t), m = parseInt(e.position) || l.DEFAULTS.position, f = p.scrollTop(), v = f, g = m - f, y = e.speed || Math.min(750, Math.min(1500, Math.abs(f - m))), w = function () {
                s()
            };
            if (!r && 0 !== g) {
        ...
        o.DEFAULTS = {
            ...
            var l = [], c = e.attr("minchecked"), h = e.attr("maxchecked") || i.maxChecked;
        ...
        var c = i(1), h = i(2), u = [], d = function (t) {
        ...
        d.prototype.createDefault = function (t) {
            ...
            constructor: o, getModuleCount: function () {
                ...
                for (var e = 0, i = 0, n = 0, s = this.rsBlock.length / 3, o = new Array, r = 0; s > r; r++)for (var l = this.rsBlock[3 * r + 0], c = this.rsBlock[3 * r + 1], h = this.rsBlock[3 * r + 2], u = 0; l > u; u++)o.push([h, c]);
        ...
        o.DEFAULTS = {
            ...
            var r = o.attr("pattern") || !1, l = new RegExp(r), c = null, h = null, u = o.is("[type=checkbox]") ? (h = i.find('input[name="' + t.name + '"]')).filter(":checked").length : o.is("[type=radio]") ? (c = this.$element.find('input[name="' + t.name + '"]')).filter(":checked").length > 0 : o.val();
            ...
            var t = this, e = this.$element, i = this.options, s = e.find(i.allFields).not(i.ignore), o = [], a = !0, r = [], l = n([]), c = [], h = !1;
            ...
            u.each(function () {
                ...
                if (u)c.push(u), h = !0; else {
                    var d = new n.Deferred;
                    c.push(d.promise()), d[s ? "resolve" : "reject"](o)
                }
            });
            var d = {valid: a, $invalidFields: l, validity: r, promises: c, async: h};
        ...
        function s() {
            var t = document.querySelector(".am-map"), e = 116.331398, i = 39.897445, n = t.getAttribute("data-name"), s = t.getAttribute("data-address"), o = t.getAttribute("data-longitude") || e, a = t.getAttribute("data-latitude") || i, r = t.getAttribute("data-setZoom") || 17, l = t.getAttribute("data-icon"), c = new BMap.Map("bd-map"), h = new BMap.Point(o, a);
        ...
        var a = function () {
            ...
            i.find("a").not(".am-parent>a").on("click", function (t) {
                ...
                l.on("click", function () {
                    ...
                    var o, a = n(this).index() > e, l = n(this)[a ? "next" : "prev"](), h = l.offset() || n(this).offset(), u = i.offset(), d = parseInt(i.css("padding-left"));
