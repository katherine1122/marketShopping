    ...
    <div class="am-g">
        <div class="am-u-sm-12 am-u-md-12">
            ...
            <div class="am-tab-panel">
                ...
                <form class="am-form " action="/system/config/update" method="post">
                    {!! csrf_field() !!}
                    {!! method_field('put') !!}
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-4 am-u-md-6">
                            <input type="hidden" value="{{$system->icon}}" name="icon">
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="infor" value="{{$system->infor}}">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="username" value="{{$system->username}}">
                        </div>
                    </div>
                    ...
                    <div class="am-g am-margin-top">
                        ...
                        <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
                            <input type="text" class="am-input-sm" name="number" value="{{$system->number}}">
                        </div>
                    </div>
