...
<div class="admin-content">
    ...
    <div class="am-g" style="padding-top: 40px">
                        ...
                        <div class="uc-order-item uc-order-item-finish">
                                ...
                                <div class="order-summary">
                                            ...
                                            @if(in_array($order->status, [3, 4]))
                                                <form style="display: inline-block"
                                                    ...
                                                    <div class="am-form-group">
                                                        <select data-am-selected="{btnWidth: '100%',  btnStyle: 'secondary',  maxHeight: 360, searchBox: 1}" id="express_id">
                                                            @foreach($expresses as $express)
                                                                <option value="{{$express->id}}"
                                                                        @if($express->id==$order->express_id) selected @endif>
                                                                    {{$express->name}}
                                                                </option>
                                                            @endforeach
                                    ...
                                    <div class="order-progress">
                                        <ol class="progress-list clearfix">
                                            ...
                                            <li class="step @if($order->status == 5) step-done @endif step-last">
                                    ...
                                    @foreach($order->order_product as $order_product)
                                        <tr>
                                            <td class="col col-thumb">
                                                <div class="figure figure-thumb">
                                                    <a target="_blank" href="//item.mi.com/1151400001.html">
                                                        <img src="{{$order_product->product->thumb}}" width="80"
                                                             height="80" alt="{{$order_product->product->thumb}}">
                                                    </a>
                                                </div>
                                            </td>
                                            ...
                                            <td class="col col-price">
                                                <p class="price">{{$order_product->product->price}}
                                                    × {{$order_product->num}}</p>
                                            </td>
                            ...
                            <div id="editAddr" class="order-detail-info">
                                ...
                                <table class="info-table">
                                    ...
                                    <tr>
                                        <th>联系电话：</th>
                                        <td><a href="tel:{{$order->customer->tel}}">{{$order->customer->tel}}</a></td>
                                    </tr>
                                    <tr>
                                        <th>收货地址：</th>
                                        <td>{{$order->order_address->pricence}}{{$order->order_address->city}}{{$order->order_address->area}}{{$order->order_address->detail}}</td>
                                    </tr>
                                    </tbody>
                                </table>
                                <div class="actions">
        ...
        $(function () {
            ...
            $('.J_deliveryTrigger').click(function(){
                ...
                if(!$detail.is(":visible")){
                    $(this).html('收起物流信息 <i class="iconfont am-icon-angle-up"></i>')
                }else{
                    $(this).html('展开物流信息 <i class="iconfont am-icon-angle-down"></i>')
                }
            ...
            $('#picking').click(function(){
                ...
                $.ajax({
                    type:'PATCH',
                    url:'/shop/product/order/picking',
                    data:{id:id},
                    success:function(){
            ...
            $('#shipping').click(function(){
                ...
                $.ajax({
                    type:'PATCH',
                    url:'/shop/product/order/shipping',
                    data:data,
                    success:function(){
                    location.href=location.href;
                    }
